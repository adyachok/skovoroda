...
class Word: Object{
    ...
    // When we test word memoization we use translation string
    // preprocessed by parsers (remover transcrip, foregn
    // word occurances replased with "~"). String can contain
    // max. 250 chars
